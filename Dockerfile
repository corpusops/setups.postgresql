# docker build --squash -t corpusops/postgresql:10 . -f Dockerfile --build-arg=SKIP_COPS_UPDATE=y --build-arg=COPS_IMG=corpusops/postgresql:10
...
ARG COPS_IMG=
ARG COPS_PROJECT_TYPE=postgresql
